"""Run IEEE DC power-flow benchmark sweep with RB-SOR + Hull KV."""
...
DEFAULT_CSV = os.path.join(RESULTS_DIR, "ieee_rbsor.csv")


def main():
    ap = argparse.ArgumentParser(description="IEEE DC PF benchmark - RB-SOR + Hull KV")
    ...
    orchestrate(
        benchmark="ieee", algorithm="rbsor", out_csv=args.csv,
