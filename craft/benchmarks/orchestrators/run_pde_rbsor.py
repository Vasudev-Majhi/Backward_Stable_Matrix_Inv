"""Run PDE benchmark sweep with RB-SOR + Hull KV."""
...
DEFAULT_CSV = os.path.join(RESULTS_DIR, "pde_rbsor.csv")


def main():
    ap = argparse.ArgumentParser(description="PDE benchmark - RB-SOR + Hull KV")
    ...
    orchestrate(
        benchmark="pde", algorithm="rbsor", out_csv=args.csv,
